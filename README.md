...
Cucumber allows automation functional validation that is easily read and understood. Cucumber was initially implemented in Ruby and then extended to Java and JavaScript framework.
...
- Easy integration with cloud services like [Sauce Labs](https://saucelabs.com/), [Browserstack](https://browserstack.com/)
- Integration of WebdriverIO's Multiremote functionality
- Easy to run tests in parallel.
- Batter reporter integrated.
...
1. Download the latest stable release [here](https://github.com/shamrat17/cucumber-test-automation-js/archive/master.zip) or clone the git repo — `git clone https://github.com/shamrat17/cucumber-test-automation-js.git`

2. Then:
- `npm install`

3. Run existing freatures
- `npm test`
...
```sh
$ npm test -- --spec ./test/features/select.feature
```
...
```sh
$ npm test -- --cucumberOpts.tagExpression='@Tag or @AnotherTag'
```
